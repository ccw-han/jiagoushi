...
public class ZooKeeperWatcher implements Watcher {
     ...
     * zookeeper服务器地址
     */
    private static final String CONNECTION_ADDR = "192.168.0.111:2181";
    /**
     * zk父路径设置
     */
    ...
    public boolean createPath(String path, String data) {
        try {
            //设置监控(由于zookeeper的监控都是一次性的所以 每次必须设置监控) 只能执行一次 如果不给true那就没有了
            //可以不给当前的，也可以new一个watcher new的话就走new的那个方法
    ...
    public boolean writeData(String path, String data) {
        //这里没有watcher事件 一定要先watcher 不然监控不到
        try {
    ...
    public void process(WatchedEvent event) {
        ...
        if (KeeperState.SyncConnected == keeperState) {
            ...
            //更新节点
                ...
                System.out.println(logPrefix + "read");
